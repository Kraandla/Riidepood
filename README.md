...
* step 3: run command "npm i" in the root folder
* step 4: once packages have installed, in the root folder run "npm run newInit"
* step 5: your api is running at address localhost:8080 website at localhost:8081
---------------------------------
